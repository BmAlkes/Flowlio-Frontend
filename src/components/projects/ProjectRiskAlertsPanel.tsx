...
export const ProjectRiskAlertsPanel = () => {
  ...
  return (
    <div className="rounded-2xl p-4 mb-4 border border-rose-200 dark:border-rose-500/20 bg-rose-50/60 dark:bg-rose-900/10">
          ...
          {alerts.map((alert) => {
            ...
            return (
              <motion.div
                ...
                className="p-3 rounded-xl border bg-card border-rose-200 dark:border-rose-500/20 cursor-pointer hover:brightness-95 transition-all"
                onClick={() =>
