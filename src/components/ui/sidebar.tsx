    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar shadow-component text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-sidebar shadow-component flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        state === "expanded" ? "classic-scroll" : "hidden-scroll",
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/90 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
