                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      dayIdx > 0 && "border-s border-border/40",
                      isToday
                    ...
                    {event && isEventStart && (
                      <div
                        className={cn(
                          ...
                          "border-s-[3px] transition-shadow duration-150",
                        ...
                        style={{
                          ...
                          borderInlineStartColor: platformColors[(event.platform as keyof typeof platformColors) ?? "none"].text,
