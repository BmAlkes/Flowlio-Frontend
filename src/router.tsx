...
const ClientPendingPage = lazy(() => import("./pages/client-pending.page"));
const ScopeChangesPage = lazy(() => import("./pages/scope-changes.page"));
const RetainersPage = lazy(() => import("./pages/retainers.page"));
const CapacityScenariosPage = lazy(() => import("./pages/capacity-scenarios.page"));
  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route
          element={<LazyWrapper component={ProjectTemplatesPage} />}
        ...
        <Route path="project/view/:id/pending" element={<AdminManagerOrOrgOwnerRoute><LazyWrapper component={ClientPendingPage} /></AdminManagerOrOrgOwnerRoute>} />
        ...
        <Route path="team-capacity/scenarios" element={<AdminManagerOrOrgOwnerRoute><LazyWrapper component={CapacityScenariosPage} /></AdminManagerOrOrgOwnerRoute>} />
        ...
        />
        <Route path="settings/workflows" element={<AdminManagerOrOrgOwnerRoute><LazyWrapper component={WorkflowsPage} /></AdminManagerOrOrgOwnerRoute>} />
        ...
        <Route
          element={
            <AdminManagerOrOrgOwnerRoute>
              <LazyWrapper component={IntegrationsPage} />
            </AdminManagerOrOrgOwnerRoute>
          }
      ...
      >
        ...
        <Route
          ...
          element={<LazyWrapper component={ProjectViewPage} />}
        />
        <Route path="pending" element={<LazyWrapper component={ClientPendingPage} />} />
