...
| 10 | T33A/B — IA contextual e revisável | FE + BE | T05, T19, T26A; T28 para comparação de escopo | Grande | Implementada; publicação em validação |
...
- T33A/B: implementada e validada localmente, com ampliação para agente interno global conforme solicitação do usuário. Publicação em validação; evidências e limites em [Agente interno contextual](t33-internal-ai-agent.md).
