...
Em 23/09/2026, o usuário autorizou continuar todos os processos faltantes, executando e validando as etapas pela sequência de dependências. T25, T26A/B, T27A/B e os refinamentos de clientes/leads estão publicados. A próxima entrega é T28A/B; as etapas seguintes permanecem no escopo autorizado. A T11 continua separada, dependente de validação PayPal Sandbox.
...
| 5 | T28A/B — Solicitações extras e mudanças de escopo | FE + BE | T18, T20, T26A | Grande | Implementada; validação/publicação em andamento |
...
- T28A/B: implementação e validação em [Mudanças de escopo](t28-scope-changes.md). Rascunho comercial preserva moeda no pedido; emissão de fatura segue o processo da equipe, sem cobrança automática.
