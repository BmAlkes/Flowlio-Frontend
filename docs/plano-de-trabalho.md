...
| T23 | Onboarding e ativação — `feat/t23-core-onboarding` | FE + BE | Checklist por papel levando ao primeiro cliente/projeto/entrega; persistência e métricas de ativação, sem completar etapas ficticiamente. | T18 | Backend 4961341 publicado; frontend 272ca4e em publicacao |
| T24 | Documentação operacional — `docs/t24-domain-runbooks` | FE + BE | README real, instalação, papéis, contratos, faturamento, jobs, releases e recuperação documentados e conferidos. | Atualizada ao longo das tarefas | Documentacao concluida e conferida; publicacao em andamento |
