...
| T21 | Capacidade da equipe — `feat/t21-team-capacity` | FE + BE | Disponibilidade semanal, estimativas, dependências, sobrecarga e filtros por equipe; estados sem estimativa explícitos. | T08, T14, T16 | Backend corrigido e publicado (426905e); frontend 68b4420 enviado para publicacao |
| T22 | Automações entre módulos — `feat/t22-workflow-automations` | FE + BE | Gatilhos/condições/ações sobre eventos persistidos, simulação, histórico, limites de encadeamento e idempotência. | T10, T18, T20 | Implementada e validada; publicacao em andamento |
